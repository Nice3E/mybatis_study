...
public class SimpleExecutorTest {
    ...
    public void test() throws SQLException {
        ...
        List<Object> objects = simpleExecutor.doQuery(ms, 10, RowBounds.DEFAULT, SimpleExecutor.NO_RESULT_HANDLER, ms.getBoundSql(10));
        List<Object> objects2 = simpleExecutor.doQuery(ms, 10, RowBounds.DEFAULT, SimpleExecutor.NO_RESULT_HANDLER, ms.getBoundSql(10));
